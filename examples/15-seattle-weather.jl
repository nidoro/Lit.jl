...
column(fill_width=true, align_items="center", margin="3rem 0 0 0") do
    column(fill_width=true, padding="0 5%") do
        h1("Seattle Weather")
        ...
        row(gap="1.5rem 3rem", margin="0 0 2rem 0", css=Dict("flex-wrap" => "wrap")) do
            ...
            metric("Max Precipitation", @sprintf("%.0fºC", max_prec_2015), @sprintf("%.0fºC", max_prec_2015 - max_prec_2014))
            metric("Min Precipitation", @sprintf("%.0fºC", min_prec_2015), @sprintf("%.0fºC", min_prec_2015 - min_prec_2014))

            metric("Max Wind", @sprintf("%.0fºC", max_wind_2015), @sprintf("%.0fºC", max_wind_2015 - max_wind_2014))
            metric("Min Wind", @sprintf("%.0fºC", min_wind_2015), @sprintf("%.0fºC", min_wind_2015 - min_wind_2014))
